...
<div class="navbar-vertical-footer">
	<button
		...
		class="btn navbar-vertical-toggle border-0 fw-semi-bold w-100 white-space-nowrap"
	>
		...
		{:else}
			<div
				class="w-100 navbar-vertical-footer-text d-flex align-items-center justify-content-center"
			>
				<div class="me-1">
					{propFooterText}
				</div>
